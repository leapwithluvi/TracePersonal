...
const RoleList = () => {
  ...
  return (
    <div>
      <h1 className="text-4xl font-semibold text-white">Roles</h1>
      <div className="mt-4">
        <Link
      ...
      <div className="mt-4 p-6 dark:bg-gray-800 rounded-lg shadow-md">
        <p className="text-2xl text-white mb-4">List Data Roles: </p>
                ...
                <table class="table-auto min-w-full rounded-xl">
                  ...
                  <tbody class="divide-y divide-gray-300 ">
                    {roles?.map((role, index) => (
                      <tr
                        class="dark:bg-gray-800 transition-all duration-500 hover:bg-gray-700 shadow-2xl rounded-xl transform transition-all duration-300 hover:scale-[1.01] animate-fade-in"
                        // key={role.id}
                      >
                        <td class=""></td>
