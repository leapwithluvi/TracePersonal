...
const Welcome = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F9F9F9] dark:bg-gray-900 px-6 py-8 flex flex-col justify-center">
      <h1 className="text-4xl font-semibold text-gray-900 dark:text-white mb-8 text-center">
        Welcome,<strong> {user && user.name}!</strong>
      </h1>

      <section className="bg-[#F9F9F9] dark:bg-gray-800 rounded-xl shadow-md max-w-[1440px] mx-auto p-8 lg:p-20 flex flex-col lg:flex-row items-center gap-12">
        <div className="w-full lg:w-[500px] text-center lg:text-left">
          <h2 className="text-3xl font-medium text-black dark:text-white font-['Space_Grotesk']">
            Let’s make things happen
          </h2>
          <p className="mt-6 mb-8 text-lg text-black dark:text-gray-300 font-['Space_Grotesk']">
            Start your wellness journey today. Take on challenges, track your
            habits, and boost your health with TracePersonal.
          </p>
          <Link
            to="/challenges"
            className="px-9 py-5 rounded-2xl text-xl font-['Space_Grotesk'] text-white dark:text-[#191a23] bg-[#191a23] dark:bg-white transition hover:opacity-90"
          >
            Get Started
          </Link>
        </div>
        ...
        <div className="w-full lg:w-[200px]">
          <svg
            ...
            height="395"
            viewBox="0 0 359 395"
            class="w-[260px] h-[260px] order-1 lg:order-2"
            fill="none"
          ...
          >
            ...
            <circle
              ...
              cy="186.5"
              r="62"
              class="dark:fill-white dark:stroke-black fill-black stroke-white"
              fill="black"
              stroke="black"
            ></circle>
            <ellipse
              ...
              rx="10"
              ry="20"
              class="dark:fill-black fill-white "
            ></ellipse>
            <ellipse
              cx="173"
              cy="173"
