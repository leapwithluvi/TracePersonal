  ...
  return (
    <div>
      ...
      <div className="mt-4 p-4 bg-white rounded-lg shadow-md">
        <section class="dark:bg-gray-800 bg-[#F9F9F9] rounded-lg">
          <div class="max-w-[1440px] mx-auto flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-0  px-20 py-10">
            <div class="w-[500px] text-center lg:text-left order-2 lg:order-1">
              <h2 class=" dark:text-white text-black text-3xl font-medium font-['Space_Grotesk']">
                Let’s make things happen
              </h2>
              <p class=" my-7 dark:text-gray-300 text-black text-lg font-normal font-['Space_Grotesk']">
                Start your wellness journey today. Take on challenges, track
                your habits, and boost your health with TracePersonal.
              </p>
              <Link
                to="/challenges"
                className="px-9 py-5 dark:bg-white bg-[#191a23] rounded-2xl   text-center dark:text-[#191a23] text-white text-xl font-normal font-['Space_Grotesk'] leading-7"
              >
                Get Started
              </Link>
            </div>
            <svg
              ...
              height="395"
              viewBox="0 0 359 395"
              class="w-[360px] h-[400px] order-1 lg:order-2"
              fill="none"
